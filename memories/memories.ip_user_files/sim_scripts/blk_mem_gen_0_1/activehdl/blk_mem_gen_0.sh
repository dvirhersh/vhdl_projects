...
#
# Script generated by Vivado on Mon Jun 09 12:15:58 +0300 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/VHDL_PROJECTS/vivado_projects/memories/memories.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
