...
HD_PWD='C:/VHDL_PROJECTS/vivado_projects/memories/memories.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_to_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_to_ram.tcl
