...
#
# mux.tcl: Tcl script for re-creating project 'mux'
#
# Generated by Vivado on Thu Jun 05 10:57:47 +0300 2025
...
#
# 1. This project restoration tcl script (mux.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/vivado_projects-1/mux/rtl/mux.vhd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/mux/rtl/mux.vhd"]"\
  ]
  foreach ifile $files {
